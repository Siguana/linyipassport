<?php
/*------------------------------------------------------------------------
 # News Basic - Version 1.0
 # ------------------------------------------------------------------------
 # Copyright (C) 2009-2010 The YouTech JSC. All Rights Reserved.
 ...
 ?>
  <div class="<?php echo $module->id; ?> post<?php if($params->get('showline')){ echo ' showlinebottom'.$iditem; } ?>">
        <div class="post-inner">
	        ...
	        <?php } ?>
		        <h2>
		        	<a title="<?php echo $item['sub_title']?>" href="<?php echo $item['link']?>"><?php echo $item['sub_title']?></a>
		        </h2>
		   <?php if ($params->get('show_description') == 1 && $item['sub_content'] !=""){?>
	            <div class="basicnews-desc"><?php echo $item['sub_content']?></div>
	       <?php } ?>
