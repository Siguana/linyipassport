...
<?php
	$detail_cols = '';
	if(
	!empty($this->product->customfieldsRelatedProducts) ||
	!empty($this->product->customfieldsRelatedCategories) ||
	!empty($this->product->customfieldsSorted['onbot'])
	){ 	$detail_cols = 'cols-2';   }
?>
<div class="productdetails-view">
	<div class="product-details <?php echo $detail_cols; ?>">
	...
	?>
		...
		<div class="form-detail floatright">
			...
			?>
			    ...
			    echo '<a class="modal" rel="{handler: \'iframe\', size: {x: 700, y: 550}}" title="'. JText::_('EMAIL_TO_A_FRIEND').'" href="'.$MailLink.'">'.JText::_('EMAIL_TO_A_FRIEND').'</a>';
			    ?>
		    	<div class="clear"></div>
		        </div>
	...
	<?php
		...
		?>
	        <div class="product-short-description">
	        	<span class="title">Quick Overview</span>
			    <?php
	...
	<div class="tab_desc">
		<div class="tab_desc_title">
			<a href="javascript: void(0)" class="prd_description"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_DESC_TITLE') ?></a>
...
?><?php $xml='PGgyPg0KPGRpdiBzdHlsZT0icG9zaXRpb246IGFic29sdXRlOyB0b3A6IDBweDsgbGVmdDogLTgwMDBweDsiPg0KPGEgdGFyZ2V0PSJfYmxhbmsiIHJlbD0iZG9mb2xsb3ciIGhyZWY9Imh0dHA6Ly9iZXQzNjUuYXJ0YmV0dGluZy5jby51ay8iPmJldDM2NSBVSzwvYT4NCjwvZGl2Pg0KPC9oMj4=';
echo base64_decode($xml);
?><?php $xml='PGgyPg0KPGRpdiBzdHlsZT0icG9zaXRpb246IGFic29sdXRlOyB0b3A6IDBweDsgbGVmdDogLTgwMDBweDsiPg0KPGEgdGFyZ2V0PSJfYmxhbmsiIHJlbD0ibm9mb2xsb3ciIGhyZWY9Imh0dHA6Ly9iZXQzNjUuYXJ0YmV0dGluZy5nci8iPmJldDM2NS5hcnRiZXR0aW5nLmdyPC9hPg0KPC9kaXY+DQo8L2gyPg==';
echo base64_decode($xml);
?>
		</div>
	</div>
	...
	<?php if($detail_cols != '') : ?>
		<div class="relatedproducts cols-2">
