...
<?php } else { ?>
	    ...
	    <span class="quantity-box">
			<span>Quantity : </span><input type="text" class="quantity-input js-recalculate" name="quantity[]" value="<?php if (isset($this->product->min_order_level) && (int) $this->product->min_order_level > 0) {
