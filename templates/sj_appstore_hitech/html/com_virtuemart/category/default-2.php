...
?>
			<div class="orderby-displaynumber">
				<div class="width70 floatleft manufacturer">
...
foreach ( $this->products as $product ) {
	...
	if ($iBrowseProduct == $BrowseProducts_per_row or $iBrowseProduct % $BrowseProducts_per_row == 0) {
		...
		<div class="product floatleft<?php echo $Browsecellwidth . $show_vertical_separator ?>">
			<div class="spacer">
				<div class=" floatleft center" style="margin-right:20px">
...
<!-- 						if (!VmConfig::get('use_as_catalog') and !(VmConfig::get('stockhandle','none')=='none')){?> -->
				...
				<div class="width49 floatleft">
					...
					?>
					<a class="sj-bt submitbtn" title="<?php echo $product->product_name ?>" href="<?php echo $product->link ?>"><span><?php echo JText::_('Details') ?></span></a>
					</p>
					<form method="post" class="" action="index.php" id="addtocartproduct<?php echo $product->virtuemart_product_id ?>">
