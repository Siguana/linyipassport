...
<div class="cart-items">
	<div class="cart-items-in">
		<?php
		$i=1;
// 		vmdebug('$this->cart->products',$this->cart->products);
		foreach( $this->cart->products as $pkey =>$prow ) { ?>
		
<div class="cart-item product<?php echo count($this->cart->products); ?>">
	<div class="cart-item-inner">
		<table>
			<tr>
				<td><?php echo JText::_('COM_VIRTUEMART_CART_NAME') ?></td>
				<td>
			...
			<tr>
				<td><?php echo JText::_('COM_VIRTUEMART_CART_SKU') ?></td>
				<td>
		...
		// 					echo $prow->salesPrice ;
			...
			<tr>
				<td><?php echo JText::_('COM_VIRTUEMART_CART_QUANTITY') ?>	/ <?php echo JText::_('COM_VIRTUEMART_CART_ACTION') ?></td>
				<td>
		...
		<tr>
			...
			<td><?php if ( VmConfig::get('show_tax')) { echo JText::_('COM_VIRTUEMART_CART_TOTAL').' ';echo "<span  class='priceColor2'>".JText::_('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT'); } ?></td>
			<td></td>
			<td><?php echo JText::_('COM_VIRTUEMART_CART_TOTAL').' ';echo JText::_('COM_VIRTUEMART_CART_PRICE'); ?></td>
		</tr>
