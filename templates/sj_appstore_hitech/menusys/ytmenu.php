	...
	class YtMenu extends YtObject{
		...
		private function _getAssetsPath(){
			...
			if(JPATH_BASE!='/'){
				...
				$relpath = str_replace(DS, "/", $relpath . DS);
			}else{
				$relpath = str_replace(DS.DS, "/", $abspath . DS);
			}
		...
		public function getLink(){
			...
			$menu_title = "<span class=\"menu-title\">" . htmlspecialchars($this->title) . "</span><span class=\"arrow-down\"></span>";
