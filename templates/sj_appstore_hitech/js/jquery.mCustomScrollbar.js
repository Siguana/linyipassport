	...
	var methods={
		init:function(options){
			...
			return this.each(function(){
				...
				// mrngoo editing
				$('li .sj-item-wrapper').bind("click",function(){
					var mCSB_clickAcTimeout;
					if(mCSB_clickAcTimeout){
						clearTimeout(mCSB_clickAcTimeout);
					}
					mCSB_clickAcTimeout=setTimeout(function(){
