...
<head>
	...
	<link rel="stylesheet" href="<?php echo JURI::base(true)."/templates/".T3_ACTIVE_TEMPLATE ?>/css/error.css" type="text/css" />
</head>
<body>
	<div class="error">
		<div id="outline">
		<div id="errorboxoutline">
			<div id="errorboxheader"><h1>404 - FourOhFour</h1></div>
			<div id="errorboxbody">
