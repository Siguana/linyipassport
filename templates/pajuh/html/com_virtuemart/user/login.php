...
<?php  } else if ( $user->id ) { ?>
   ...
   <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="login" id="form-login" style="padding-bottom:15px;">
        <?php echo JText::sprintf( 'COM_VIRTUEMART_HINAME', $user->name ); ?><br/>
