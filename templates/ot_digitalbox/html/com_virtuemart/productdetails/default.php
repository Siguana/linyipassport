...
?>
<script src="<?php echo JURI::root().'/templates/'.'ot_digitalbox/html/com_virtuemart/simple_thumbs.js'; ?>" type="text/javascript"></script>
	...
	*/
    ...
    <div class="product-preview">
		...
		<div class="product-detailts">
			<?php // Product Title ?>
			<h1 class="product-name-details"><?php echo $this->product->product_name ?></h1>
			<?php // Product Title END ?>
		...
		echo $pane->startPane('otcustom-title-tabs');
			if (!empty($this->product->product_desc)) { ?>
				...
				<div id="product-description-details-page" class="product-description">
					...
					<div id="product-details-page-desc" class="product-details-page-desc"><?php echo $this->product->product_desc; ?></div>
					<!--
			...
			if (!empty($this->product->customfieldsRelatedProducts)) {
				echo $pane->startPanel(JText::_('COM_VIRTUEMART_RELATED_PRODUCTS'), 'otcustom-title-tab-'.$i++);
				echo $this->loadTemplate('relatedproducts');
			} // Product customfieldsRelatedProducts END
			
			if (!empty($this->product->customfieldsRelatedCategories)) {
				echo $pane->startPanel(JText::_('COM_VIRTUEMART_RELATED_CATEGORIES'), 'otcustom-title-tab-'.$i++);
