...
?>
			<div class="orderby-displaynumber">
				...
				<div id="top-pagination"><p class="pagescounter"><span><?php echo $this->vmPagination->getPagesCounter(); ?></span></p><p class="pageslinks"><?php echo $this->vmPagination->getPagesLinks(); ?></p></div>
				<?php endif; ?>
			...
			<div class="spacer">
				<div class="ot-custom-product">
					<div class="ot-custom-product-i">
						...
						<?php //echo shopFunctionsF::limitStringByWord($product->product_desc, 300, '...') ?>
						</p> -->
						<?php //} ?>
...
<!-- /div removed valerie -->
	<?php if($this->vmPagination->getPagesCounter() != null) : ?>
	<div id="bottom-pagination"><p class="pagescounter"><span><?php echo $this->vmPagination->getPagesCounter(); ?></span></p><p class="pageslinks"><?php echo $this->vmPagination->getPagesLinks(); ?></p></div>
	<?php endif; ?>
<!-- /div removed valerie -->
